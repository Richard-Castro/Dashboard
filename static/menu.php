<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Configurações</span>
              ...
              <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Serviços</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Login</span>
            </a>
					</li>
                    <li class="sidebar-item">
						<a class="sidebar-link" href="ui-buttons.html">
              <i class="align-middle" data-feather="square"></i> <span class="align-middle">Registrar</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="check-square"></i> <span class="align-middle">Pix</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="charts-chartjs.html">
                            <i class="align-middle" data-feather="bar-chart-2"></i> <span class="align-middle">Pagamentos a receber</span>
                        </a>
					</li>
